...
- **Visual fundamentals:** Impeccable, Human Taste, and the supporting creative
  skills ship in the public profile payload so a new installation has the same
  design baseline as the tested fleet release.
