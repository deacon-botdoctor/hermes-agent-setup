...
description: Load client-neutral visual patterns, production lanes, required inputs, and QA gates before generating visual artifacts.
version: 1.0.0
platforms:
- linux
- macos
...
2. If the ask needs originality, direction-setting, or feels generic, run a creative-ideation pass before production: generate 3-5 distinct concept directions using named creative/design methodologies, then choose the best feasible direction.
